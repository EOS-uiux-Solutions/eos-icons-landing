(function () {
  ...
  let iconName, iconSize, iconDemo, iconClass; // hide code snippet by default
  ...
  const iconsListData = () => {
    getIconsList(function (data) {
      ...
      for (let i = 0; i < iconsList.length; i++) {
        ...
        const iconName = iconsList[i]; // Add icon name
...
const generate = () => {
  ...
  } else alert("Please select atleast one icon to generate font");
};
