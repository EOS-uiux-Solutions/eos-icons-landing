          ...
          <>
            <div className="container">
              <div>
                ...
                <p>Like many websites, the EOS design system uses 'cookies'. A cookie is a small file of letters 
                and numbers that is placed on your computer's hard drive when you visit certain websites. 
                We may use cookies to tell us, for example, whether you have visited us before or if you are a 
                new visitor and to help us identify site features in which you may have the greatest interest. 
                Cookies may enhance your online experience by saving your preferences while you are visiting a 
                particular page. For more information on cookies, please see<a href="www.whatarecookies.com" 
                data-event-category="External link" data-event-action="Link to whatarecookies.com" 
                data-event-label="Cookies policy">www.whatarecookies.com</a></p>
                <p>The cookies we use are 
                'analytics cookies' which monitor how visitors use our websites and give us a better understanding of
                 ...
                 <div className="cookies-table">
                  ...
                  <div className="cookies-table-content">
                    ...
                    <div>
                      <p>These cookies are used only to help us to improve our websites over time, by giving 
                      us insights into how the various sections of the websites are used and how users interact 
                      with the websites, for example which pages visitors go to most often and whether they get 
                      error messages from web pages. The information collected is anonymous and statistical.
                      </p>
                    </div>
                    <div>
                      <span>AID</span>
